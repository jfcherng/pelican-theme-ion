    ...
    var _ = {
        ...
        initConfig: function(config) {
            ...
            if ('grid' in _.config &&
                ...
                _.config.grid.gutters = {
                    vertical: _.config.grid.gutters,
                    horizontal: _.config.grid.gutters
                };
            ...
            _.iterate(_.config.breakpoints, function(id) {
                ...
                if ('grid' in c &&
                    ...
                    c.grid.gutters = {
                        vertical: c.grid.gutters,
                        horizontal: c.grid.gutters
                    };
        ...
        initUtilityMethods: function() {
            ...
            // Otherwise, polyfill.
                ...
                _.getElementsByClassName = function(className) {
                    var d = document;
                    if (d.querySelectorAll) return d.querySelectorAll(('.' + className.replace(' ', ' .')).replace(/\.([0-9])/, '.\\3$1 '));
                    else return [];
                }
